/** Copied in spirit from browser-use/jev-ultrafast `jev_ultrafast/questions.py`. */
...
If Continue/Send is visible and the required fields are ready, CLICK it immediately.
...
export const OPERATION_LABELS: Record<string, string> = {
  CLICK: "Click an element, button, menu option, or drop zone.",
  TYPE_TEXT:
    "Enter or replace text in an editable field. A small helper will supply the value from the goal.",
  SELECT: "Select an observed dropdown value.",
  WAIT: "Wait when a needed control is absent or the document preview is still preparing.",
